...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { name: @favorite.name, reason: @favorite.reason } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { name: @favorite.name, reason: @favorite.reason } }
